...
**Feature Branch**: `001-time-config`  
**Created**: 2026-05-10  
**Status**: Draft  
**Input**: User description: "Reference the initial architecture and create the first TimeConfig feature for Gamble With Your Friends."
...
**Why this priority**: This is the core value of TimeConfig. Without host-controlled time
