...
public static class NativeLobbySettingsMenu
{
    ...
    public const string SectionKey = "configmanager.section";
    public const string TimeSectionKey = "configmanager.time.section";
    public const string QuotaSectionKey = "configmanager.quota.section";
    public const string DayDurationMinutesKey = "configmanager.day-duration-minutes";
    public const string StartingQuotaKey = "configmanager.starting-quota";
    public const string CatchUpFactorKey = "configmanager.catch-up-factor";
    public const string QuotaScalingModeKey = "configmanager.quota-scaling-mode";
    public const string QuotaPatternLengthKey = "configmanager.quota-pattern-length";
    ...
    {
        if (_isSynchronizing || entry == null || !IsConfigManagerKey(entry.key) || _lobbySettingsLayout == null)
        {
            return;
        }
    ...
    private static bool IsConfigManagerKey(string? key) =>
    ...
    private static string GetQuotaMultiplierKey(int index) =>
        $"configmanager.quota-multiplier-{index + 1}";

    private static bool IsQuotaMultiplierKey(string? key) =>
        !string.IsNullOrWhiteSpace(key) &&
        key.StartsWith("configmanager.quota-multiplier-", StringComparison.OrdinalIgnoreCase);
}